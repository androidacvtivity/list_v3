...
import com.bancusoft.listv3.Helpers.MyAdaptercltari;
...
import com.bancusoft.listv3.Retrofit.ResponseModelCl_tari;
...
public class ScientistsActivitycltari extends AppCompatActivity
        implements SearchView.OnQueryTextListener,MenuItem.OnActionExpandListener{

    //We define our instance fields
    private RecyclerView rv;
    private MyAdaptercltari mAdapter;
    private LinearLayoutManager layoutManager;
    public ArrayList<Cl_tari> allPagesScientists = new ArrayList<>();
    private List<Cl_tari> currentPageScientists;
    ...
    private void initializeViews() {
        mProgressBar = findViewById(R.id.mProgressBarLoad_cl_tari);
        mProgressBar.setIndeterminate(true);
        Utils.showProgressBar(mProgressBar);
        rv = findViewById(R.id.mRecyclerView_cl_tari);
    }
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdaptercltari(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        Call<ResponseModelCl_tari> retrievedData;

        if (action.equalsIgnoreCase("GET_PAGINATEDCLTARI")) {
            retrievedData = api.search_cl_tari("GET_PAGINATEDCLTARI", queryString, start, "100");
            Utils.showProgressBar(mProgressBar);
        } else if (action.equalsIgnoreCase("GET_PAGINATED_SEARCLTARI")) {
            Utils.showProgressBar(mProgressBar);
            retrievedData = api.search_cl_tari("GET_PAGINATED_SEARCLTARI", queryString, start, "100");
        } else {
            Utils.showProgressBar(mProgressBar);
            retrievedData = api.retrievecltari();
        }
        ...
        retrievedData.enqueue(new Callback<>() {
            ...
            @Override
            public void onResponse(@NonNull Call<ResponseModelCl_tari> call, @NonNull Response<ResponseModelCl_tari>
                    response) {
                assert response.body() != null;
                Log.d("RETROFIT", "CODE : " + response.body().getCodecu());
                Log.d("RETROFIT", "MESSAGE : " + response.body().getMessagecu());
                Log.d("RETROFIT", "RESPONSE : " + response.body().getResultCl_tari());
                currentPageScientists = response.body().getResultCl_tari();

                if (currentPageScientists != null && !currentPageScientists.isEmpty()) {
                    if (action.equalsIgnoreCase("GET_PAGINATED_SEARCLTARI")) {
            ...
            @Override
            public void onFailure(@NonNull Call<ResponseModelCl_tari> call, @NonNull Throwable t) {
                Utils.hideProgressBar(mProgressBar);
                Log.d("RETROFIT", "ERROR: " + t.getMessage());
                Utils.showInfoDialog(ScientistsActivitycltari.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
        ...
        rv.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView rv, int dx, int dy) {
                ...
                if (isScrolling && (currentScientists + scrolledOutScientists ==
                    ...
                    if (dy > 0) {
                        // Scrolling up
                        retrieveAndFillRecyclerView("GET_PAGINATEDCLTARI",
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.scientists_page_menu_cl_tari, menu);
        MenuItem searchItem = menu.findItem(R.id.action_search_cl_tari);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id==R.id.action_new_en_cl_tari){
        ...
        if (id==R.id.action_new_ru_cl_tari){
    ...
    public boolean onQueryTextChange(String query) {
        retrieveAndFillRecyclerView("GET_PAGINATED_SEARCLTARI", query, "0");
        return false;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cl_tarii);
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ...
                Intent intent = new Intent(ScientistsActivitycltari.this, DashboardActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                finish();
                startActivity(intent);
            }
...
//-----------------------------
        ...
        setupRecyclerView();
        retrieveAndFillRecyclerView("GET_PAGINATEDCLTARI", "", "0");
    }
}
