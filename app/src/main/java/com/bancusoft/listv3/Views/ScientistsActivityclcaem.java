...
import com.bancusoft.listv3.Helpers.MyAdapterclcaem;

import com.bancusoft.listv3.Helpers.Utils;
import com.bancusoft.listv3.R;


import com.bancusoft.listv3.Retrofit.ResponseModelcaemcl;
...
public class ScientistsActivityclcaem extends AppCompatActivity
    ...
    private void setupRecyclerView() {
        ...
        mAdapter = new MyAdapterclcaem(this, allPagesScientists);
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        retrievedData.enqueue(new Callback<>() {
            ...
            public void onResponse(@NonNull Call<ResponseModelcaemcl> call, @NonNull Response<ResponseModelcaemcl>
                ...
                currentPageScientists = response.body().getResultcaemcl();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.scientists_page_menu_cl_caem, menu);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cl_caem);
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ...
                Intent intent = new Intent(ScientistsActivityclcaem.this, DashboardActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                finish();
                startActivity(intent);
            }
