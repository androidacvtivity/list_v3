...
import com.bancusoft.listv3.Helpers.MyAdapterclcocm;

import com.bancusoft.listv3.Helpers.Utils;
import com.bancusoft.listv3.R;


import com.bancusoft.listv3.Retrofit.ResponseModelCl_cocm;
...
public class ScientistsActivityclcocm extends AppCompatActivity
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        if (action.equalsIgnoreCase("GET_PAGINATEDCOCM")) {
            retrievedData = api.search_cl_cocm("GET_PAGINATEDCOCM", queryString, start, "100");
            Utils.showProgressBar(mProgressBar);
        } else if (action.equalsIgnoreCase("GET_PAGINATED_SEARCHCOCM")) {
            Utils.showProgressBar(mProgressBar);
            retrievedData = api.search_cl_cocm("GET_PAGINATED_SEARCHCOCM", queryString, start, "100");
        } else {
            Utils.showProgressBar(mProgressBar);
        ...
        retrievedData.enqueue(new Callback<>() {
            ...
            @Override
            public void onResponse(@NonNull Call<ResponseModelCl_cocm> call, @NonNull Response<ResponseModelCl_cocm>
                    response) {
            ...
            @Override
            public void onFailure(@NonNull Call<ResponseModelCl_cocm> call, @NonNull Throwable t) {
                Utils.hideProgressBar(mProgressBar);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id==R.id.action_new_en_cl_cocm){
        ...
        if (id==R.id.action_new_ru_cl_cocm){
    ...
    public boolean onQueryTextChange(String query) {
        retrieveAndFillRecyclerView("GET_PAGINATED_SEARCHCOCM", query, "0");
        return false;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ...
                Intent intent = new Intent(ScientistsActivityclcocm.this, DashboardActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                finish();
                startActivity(intent);
            }
...
//-----------------------------
        ...
        setupRecyclerView();
        retrieveAndFillRecyclerView("GET_PAGINATEDCOCM", "", "0");
    }
